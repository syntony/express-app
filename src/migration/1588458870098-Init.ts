...
export class Init1588458870098 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_offer" ("id" varchar PRIMARY KEY NOT NULL, "guest" varchar NOT NULL, "guestsNumber" integer NOT NULL, "reservedFrom" date NOT NULL, "reservedUntil" date NOT NULL, "storeId" varchar NOT NULL, "hookahId" varchar NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "FK_863e1890733fe417777e214dccb" FOREIGN KEY ("storeId") REFERENCES "store" ("id"), CONSTRAINT "FK_5d2a1caa3af8e3bb96848250761" FOREIGN KEY ("hookahId") REFERENCES "hookah" ("id"))`
    )
    await queryRunner.query(
